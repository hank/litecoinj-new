...
import com.google.litecoin.wallet.DefaultRiskAnalysis;
import com.google.litecoin.wallet.RiskAnalysis;
...
import com.google.litecoin.script.ScriptChunk;
import com.google.litecoin.store.UnreadableWalletException;
...
import com.google.litecoin.wallet.*;
...
import static com.google.litecoin.core.Utils.bitcoinValueToFriendlyString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.litecoin.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.litecoin.core.Wallet#getBalance()} - the fees required
         ...
         *
         * <p>Once {@link Wallet#completeTx(com.google.litecoin.core.Wallet.SendRequest)} is called, this is set to the
        ...
        /**
         * If not null, the {@link com.google.litecoin.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.litecoin.wallet.WalletFiles.Listener)}
     ...
     * of {@link com.google.litecoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link com.google.litecoin.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.litecoin.core.TransactionBroadcaster broadcaster) {
        lock.lock();
        try {
