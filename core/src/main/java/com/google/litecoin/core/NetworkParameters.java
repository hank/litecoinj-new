...
public abstract class NetworkParameters implements Serializable {
    ...
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.litecoin.unittest";
    ...
    /**
     * First byte of a base58 encoded address. See {@link com.google.litecoin.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link com.google.litecoin.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link com.google.litecoin.core.AlertMessage}s. You can use {@link com.google.litecoin.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
